...
slides = [
    ...
    {"file": "06_valgrind.html", "title": "Valgrind: принцип роботи", "img": "img/valgrind.png"},
    {"file": "07_comparison.html", "title": "Порівняння: що ловлять ASan та Valgrind", "img": "img/comparison1.png"},
]
...
# contents
html = contents_tpl.render(slides=slides, title="До лекції №6")
